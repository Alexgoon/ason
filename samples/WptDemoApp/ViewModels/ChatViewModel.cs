...
public partial class ChatViewModel : ObservableObject {
    [ObservableProperty]
    string userInput = "Update fist three employee names to Alexaner Russkov";
    ...
    public ChatViewModel(MainViewModel mainViewModel) {
        ...
        var options = new AsonClientOptions {
            ...
            RunnerMode = ExecutionMode.Docker,
    ...
    async Task SendMessage() {
        ...
        // After streaming completes append assistant reply to history
