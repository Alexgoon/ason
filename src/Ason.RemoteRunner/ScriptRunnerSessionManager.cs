...
public static class RemoteRunnerServiceExtensions {
    public static IServiceCollection AddRemoteScriptRunner(this IServiceCollection services, Action<RemoteScriptRunnerOptions>? configure = null) {
        services.AddSignalR();
    ...
    public static HubEndpointConventionBuilder MapRemoteScriptRunner(this IEndpointRouteBuilder endpoints, string pattern = "/scriptRunnerHub", bool requireAuthorization = false) {
