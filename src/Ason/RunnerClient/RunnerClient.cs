...
namespace Ason;
internal sealed class RunnerClient(ConcurrentDictionary<string, OperatorBase> handleToObject, SynchronizationContext? synchronizationContext) {
    ...
    public async Task StartProcessAsync() {
        // Do NOT initialize invokers yet; wait for MethodCache to be set.
        ...
        _transport = UseRemote
            ...
            : new StdIoProcessTransport(Mode, DockerImage);
